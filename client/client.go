...
type Client interface {
	...
	// Id returns unique table record identifier generated by the database.
	// Valid for actions: insert, pubsub insert, pubsub add, 
	// pubsub delete, pubsub remove, pubsub update.
	Id() string
